...
**Update Window:** Monday January 3, 2:00 PM

**Personnel:** Terri, Michael, Edwin, Temi, Marek

**Content Freeze:** Four hours (2:00 PM - 6:00 PM)
...
1. Ensure the rawAccess: true flag is set in the PRISMA_CONFIG under databases
...
1. Uninstall temporary NPM packages by running `npm uninstall elasticsearch http-aws-es ajv json-diff`
